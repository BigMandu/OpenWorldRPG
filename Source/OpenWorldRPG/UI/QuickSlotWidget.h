...
public:
	...
	bool SetItemInQuickSlot(EQuickSlotNumber QuickSlotNum, UNewItemObject* ItemObj);

	bool CheckAndRegisterQuickSlot(EQuickSlotNumber QuickSlotNum, UNewItemObject* ItemObj, bool bIsNeedOnlyDeleted);
	...
	*/
	...
	/**
	 * 이 함수도 NewInventoryGrid::RefreshInventroy 함수에서 호출된다.
	 */
	EQuickSlotNumber JudgeCanbeInQuickSlotOrUpdate(UNewItemObject* ItemObj);
